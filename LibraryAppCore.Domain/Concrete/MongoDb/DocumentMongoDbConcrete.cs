...
{
    public class DocumentMongoDbConcrete: IDocumentRepository
    {
        private List<Book> bookList = new List<Book>();
        private IAuthorRepository authorRepo;
        private IBookRepository bookRepo;

        public DocumentMongoDbConcrete(IAuthorRepository _authorRepository, IBookRepository _bookRepository)
        {
